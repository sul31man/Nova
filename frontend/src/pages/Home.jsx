    ...
    <div className="home-container">
      <div className="home-content">
        ...
        <div className="api-status">
          <span className="code-accent">API Status:</span> {apiError ? `Error: ${apiError}` : apiMessage}
        </div>
        <section className="product-section">
          <h2 className="section-title">What is Nova?</h2>
          <p className="product-description" style={{ fontWeight: 'bold', marginBottom: '1rem', color: '#ff6b9d' }}>MANIFESTO:</p>
